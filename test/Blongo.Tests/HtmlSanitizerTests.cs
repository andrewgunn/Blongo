        ...
        public static IEnumerable HtmlSanitizerTestData
        {
            get
            {
                yield return
                    new object[]
                    {
                        "<a href=\"http://blog.andrewgunn.co.uk\">Andrew Gunn's Blog</a>",
                        "<a href=\"http://blog.andrewgunn.co.uk\">Andrew Gunn's Blog</a>"
                    };
                yield return
                    new object[]
                    {
                        "<a href=\"http://blog.andrewgunn.co.uk\" title=\"Andrew Gunn's Blog\">Andrew Gunn's Blog</a>",
                        "<a href=\"http://blog.andrewgunn.co.uk\" title=\"Andrew Gunn's Blog\">Andrew Gunn's Blog</a>"
                    };
                ...
                yield return
                    new object[]
                    {
                        "<img src=\"http://blog.andrewgunn.co.uk/favicon-16x16.png\" />",
                        "<img src=\"http://blog.andrewgunn.co.uk/favicon-16x16.png\" />"
                    };
                yield return
                    new object[]
                    {
                        "<img src=\"http://blog.andrewgunn.co.uk/favicon-16x16.png\" width=\"16\" height=\"16\" alt=\"Favicon\" />",
                        "<img src=\"http://blog.andrewgunn.co.uk/favicon-16x16.png\" width=\"16\" height=\"16\" alt=\"Favicon\" />"
                    };
